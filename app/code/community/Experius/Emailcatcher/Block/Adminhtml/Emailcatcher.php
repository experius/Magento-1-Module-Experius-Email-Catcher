...
* @subpackage       Block_Adminhtml_Emailcatcher    
...
*/ 
class Experius_Emailcatcher_Block_Adminhtml_Emailcatcher extends Mage_Adminhtml_Block_Widget_Grid_Container {
	
	public function __construct() {
		$this->_controller = 'adminhtml_emailcatcher';
